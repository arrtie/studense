class AdminRequestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_request.save
        format.html { redirect_to @admin_request, notice: "Admin request was successfully created." }
  ...
  def update
    respond_to do |format|
      if @admin_request.update(admin_request_params)
        format.html { redirect_to @admin_request, notice: "Admin request was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_requests_path, status: :see_other, notice: "Admin request was successfully destroyed." }
