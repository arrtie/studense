...
RSpec.describe "/admins", type: :request do
  ...
  let(:current_account) {
    FactoryBot.create(:account, email: "test@test.com", password:, password_confirmation: password)
  }

  fcontext "when authenticated" do
    before(:example) do
    ...
    describe "GET /index" do
      it "renders a successful response" do
        get admins_url, headers: @env
        expect(response).to be_successful
      end
    end
  end

  fcontext "when not authenticated" do
    describe "GET /index" do
  ...
  describe "GET /edit" do
    it "routes to #edit" do
      expect { get "/admins/1/edit" }.to raise_error(ActionController::RoutingError)
    end
  end
